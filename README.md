...
[![Status](https://img.shields.io/badge/status-P4%20Planned-EF4444)](https://github.com/dclawstack/dclaw-offboard)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/offboard)

---

## Overview

DClaw Offboard is an AI-native hr application. It follows the standard DClaw architecture:
...
DClaw Offboard uses the **DKube Design System** with its app-specific brand color.
...
```bash
git clone https://github.com/dclawstack/dclaw-offboard.git
cd dclaw-offboard
```
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_offboard"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-offboard.git /opt/dclaw-offboard
cd /opt/dclaw-offboard
docker compose up -d
```

The app will be available at `https://offboard.dclawstack.io`.

### Kubernetes

```bash
cd helm/dclaw-offboard
helm dependency build
helm upgrade --install dclaw-offboard . \
  --namespace dclaw-offboard \
  --create-namespace
```
...
- [Docs](https://docs.dclawstack.io/apps/offboard)
