...
**DClaw Offboard** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8042` (FastAPI)
- **Frontend Port:** `3042` (Next.js)
- **Database:** `dclaw_offboard` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3042`
